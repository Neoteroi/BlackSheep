# examples of multipart form content generated by Opera:

FIELDS_THREE_VALUES = "------WebKitFormBoundaryYEnGnPBYJ8Y8CExC\r\nContent-Disposition: form-data; " \
                      "name=\"one\"\r\n\r\naaa\r\n------WebKitFormBoundaryYEnGnPBYJ8Y8CExC\r\nContent-Disposition: " \
                      "form-data; name=\"one\"\r\n\r\nbbb\r\n------WebKitFormBoundaryYEnGnPBYJ8Y8CExC\r\nContent" \
...
FIELDS_WITH_CARRIAGE_RETURNS = "------WebKitFormBoundaryyxVdKlePrAk93BbA\r\nContent-Disposition: form-data; " \
...
FIELDS_WITH_SMALL_PICTURE = b'------WebKitFormBoundarypZguvAtDggx51LrW\r\nContent-Disposition: form-data; ' \
                            ...
                            b'-Disposition: form-data; ' \
                            b'name="two"\r\n\r\nexample\r\n------WebKitFormBoundarypZguvAtDggx51LrW\r\nContent' \
                            b'-Disposition: form-data; name="file_example"; ' \
                            b'filename="example-001.png"\r\nContent-Type: ' \
